...
hyperdog_uros_msgs__msg__Limit__create()
{
  ...
  hyperdog_uros_msgs__msg__Limit * msg = (hyperdog_uros_msgs__msg__Limit *)allocator.allocate(sizeof(hyperdog_uros_msgs__msg__Limit), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hyperdog_uros_msgs__msg__Limit));
  bool success = hyperdog_uros_msgs__msg__Limit__init(msg);
  if (!success) {
...
hyperdog_uros_msgs__msg__Limit__destroy(hyperdog_uros_msgs__msg__Limit * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    hyperdog_uros_msgs__msg__Limit__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
hyperdog_uros_msgs__msg__Limit__Sequence__init(hyperdog_uros_msgs__msg__Limit__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hyperdog_uros_msgs__msg__Limit * data = NULL;

  if (size) {
    data = (hyperdog_uros_msgs__msg__Limit *)allocator.zero_allocate(size, sizeof(hyperdog_uros_msgs__msg__Limit), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hyperdog_uros_msgs__msg__Limit__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hyperdog_uros_msgs__msg__Limit__fini(&data[i - 1]);
      }
...
hyperdog_uros_msgs__msg__Limit__Sequence__fini(hyperdog_uros_msgs__msg__Limit__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hyperdog_uros_msgs__msg__Limit__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hyperdog_uros_msgs__msg__Limit__Sequence * array = (hyperdog_uros_msgs__msg__Limit__Sequence *)allocator.allocate(sizeof(hyperdog_uros_msgs__msg__Limit__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hyperdog_uros_msgs__msg__Limit__Sequence__init(array, size);
  if (!success) {
...
hyperdog_uros_msgs__msg__Limit__Sequence__destroy(hyperdog_uros_msgs__msg__Limit__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hyperdog_uros_msgs__msg__Limit__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hyperdog_uros_msgs__msg__Limit__Sequence__are_equal(const hyperdog_uros_msgs__msg__Limit__Sequence * lhs, const hyperdog_uros_msgs__msg__Limit__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hyperdog_uros_msgs__msg__Limit__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hyperdog_uros_msgs__msg__Limit__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hyperdog_uros_msgs__msg__Limit);
    hyperdog_uros_msgs__msg__Limit * data =
      (hyperdog_uros_msgs__msg__Limit *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hyperdog_uros_msgs__msg__Limit__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hyperdog_uros_msgs__msg__Limit__fini(&data[i]);
        }
        free(data);
        return false;
      }
