...
#ifndef HYPERDOG_UROS_MSGS__MSG__DETAIL__MOTOR_PARAMS__STRUCT_H_
#define HYPERDOG_UROS_MSGS__MSG__DETAIL__MOTOR_PARAMS__STRUCT_H_
...
typedef struct hyperdog_uros_msgs__msg__MotorParams
{
  ...
  hyperdog_uros_msgs__msg__Limit kd;
  hyperdog_uros_msgs__msg__Limit i_ff;
} hyperdog_uros_msgs__msg__MotorParams;

// Struct for a sequence of hyperdog_uros_msgs__msg__MotorParams.
typedef struct hyperdog_uros_msgs__msg__MotorParams__Sequence
{
...
#endif  // HYPERDOG_UROS_MSGS__MSG__DETAIL__MOTOR_PARAMS__STRUCT_H_
