...
#include "hyperdog_uros_msgs/srv/detail/disable_all_motors__functions.h"
...
hyperdog_uros_msgs__srv__DisableAllMotors_Request__create()
{
  ...
  hyperdog_uros_msgs__srv__DisableAllMotors_Request * msg = (hyperdog_uros_msgs__srv__DisableAllMotors_Request *)allocator.allocate(sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Request));
  bool success = hyperdog_uros_msgs__srv__DisableAllMotors_Request__init(msg);
  if (!success) {
...
hyperdog_uros_msgs__srv__DisableAllMotors_Request__destroy(hyperdog_uros_msgs__srv__DisableAllMotors_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    hyperdog_uros_msgs__srv__DisableAllMotors_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence__init(hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hyperdog_uros_msgs__srv__DisableAllMotors_Request * data = NULL;

  if (size) {
    data = (hyperdog_uros_msgs__srv__DisableAllMotors_Request *)allocator.zero_allocate(size, sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hyperdog_uros_msgs__srv__DisableAllMotors_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hyperdog_uros_msgs__srv__DisableAllMotors_Request__fini(&data[i - 1]);
      }
...
hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence__fini(hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hyperdog_uros_msgs__srv__DisableAllMotors_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence * array = (hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence *)allocator.allocate(sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence__init(array, size);
  if (!success) {
...
hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence__destroy(hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence__are_equal(const hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence * lhs, const hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hyperdog_uros_msgs__srv__DisableAllMotors_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hyperdog_uros_msgs__srv__DisableAllMotors_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Request);
    hyperdog_uros_msgs__srv__DisableAllMotors_Request * data =
      (hyperdog_uros_msgs__srv__DisableAllMotors_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hyperdog_uros_msgs__srv__DisableAllMotors_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hyperdog_uros_msgs__srv__DisableAllMotors_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hyperdog_uros_msgs__srv__DisableAllMotors_Request__copy(
...
hyperdog_uros_msgs__srv__DisableAllMotors_Response__init(hyperdog_uros_msgs__srv__DisableAllMotors_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->error_msg)) {
    hyperdog_uros_msgs__srv__DisableAllMotors_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hyperdog_uros_msgs__srv__DisableAllMotors_Response * msg = (hyperdog_uros_msgs__srv__DisableAllMotors_Response *)allocator.allocate(sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Response));
  bool success = hyperdog_uros_msgs__srv__DisableAllMotors_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence__init(hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hyperdog_uros_msgs__srv__DisableAllMotors_Response * data = NULL;

  if (size) {
    data = (hyperdog_uros_msgs__srv__DisableAllMotors_Response *)allocator.zero_allocate(size, sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hyperdog_uros_msgs__srv__DisableAllMotors_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hyperdog_uros_msgs__srv__DisableAllMotors_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence__fini(hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hyperdog_uros_msgs__srv__DisableAllMotors_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence * array = (hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence *)allocator.allocate(sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence__destroy(hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence__are_equal(const hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence * lhs, const hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hyperdog_uros_msgs__srv__DisableAllMotors_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hyperdog_uros_msgs__srv__DisableAllMotors_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hyperdog_uros_msgs__srv__DisableAllMotors_Response);
    hyperdog_uros_msgs__srv__DisableAllMotors_Response * data =
      (hyperdog_uros_msgs__srv__DisableAllMotors_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hyperdog_uros_msgs__srv__DisableAllMotors_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hyperdog_uros_msgs__srv__DisableAllMotors_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hyperdog_uros_msgs__srv__DisableAllMotors_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
