...
#ifndef HYPERDOG_UROS_INTERFACES__SRV__DETAIL__ENABLE_MOTOR2__FUNCTIONS_H_
#define HYPERDOG_UROS_INTERFACES__SRV__DETAIL__ENABLE_MOTOR2__FUNCTIONS_H_
...
#include "hyperdog_uros_interfaces/srv/detail/enable_motor2__struct.h"
 ...
 * calls
 * hyperdog_uros_interfaces__srv__EnableMotor2_Request__init().
...
/**
 * It calls
 * hyperdog_uros_interfaces__srv__EnableMotor2_Request__fini()
 ...
 * hyperdog_uros_interfaces__srv__EnableMotor2_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hyperdog_uros_interfaces__srv__EnableMotor2_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hyperdog_uros_interfaces__srv__EnableMotor2_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hyperdog_uros_interfaces
...
/**
 * It calls
 * hyperdog_uros_interfaces__srv__EnableMotor2_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hyperdog_uros_interfaces
...
/**
 * It allocates the memory for the array and calls
 * hyperdog_uros_interfaces__srv__EnableMotor2_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hyperdog_uros_interfaces
...
/**
 * It calls
 * hyperdog_uros_interfaces__srv__EnableMotor2_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HYPERDOG_UROS_INTERFACES__SRV__DETAIL__ENABLE_MOTOR2__FUNCTIONS_H_
