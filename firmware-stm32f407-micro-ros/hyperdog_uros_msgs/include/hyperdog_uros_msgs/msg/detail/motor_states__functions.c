...
hyperdog_uros_msgs__msg__MotorStates__init(hyperdog_uros_msgs__msg__MotorStates * msg)
{
  ...
  // motor_name
  if (!rosidl_runtime_c__String__Sequence__init(&msg->motor_name, 0)) {
...
hyperdog_uros_msgs__msg__MotorStates__fini(hyperdog_uros_msgs__msg__MotorStates * msg)
{
  ...
  // motor_name
  rosidl_runtime_c__String__Sequence__fini(&msg->motor_name);
  // id
  // is_available
  // is_enabled
  // is_error
...
hyperdog_uros_msgs__msg__MotorStates__are_equal(const hyperdog_uros_msgs__msg__MotorStates * lhs, const hyperdog_uros_msgs__msg__MotorStates * rhs)
{
  ...
  // cur_position
  if (lhs->cur_position != rhs->cur_position) {
    return false;
  }
  // cur_velocity
  if (lhs->cur_velocity != rhs->cur_velocity) {
    return false;
  }
  // torque
  ...
  hyperdog_uros_msgs__msg__MotorStates * output)
{
  ...
  // cur_position
  output->cur_position = input->cur_position;
  // cur_velocity
  output->cur_velocity = input->cur_velocity;
  // torque
