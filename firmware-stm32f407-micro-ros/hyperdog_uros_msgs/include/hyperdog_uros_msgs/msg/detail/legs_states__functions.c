...
hyperdog_uros_msgs__msg__LegsStates__init(hyperdog_uros_msgs__msg__LegsStates * msg)
{
  ...
  // fr_leg
  if (!hyperdog_uros_msgs__msg__LegStates__init(&msg->fr_leg)) {
    hyperdog_uros_msgs__msg__LegsStates__fini(msg);
    return false;
  }
  // fl_leg
  if (!hyperdog_uros_msgs__msg__LegStates__init(&msg->fl_leg)) {
    hyperdog_uros_msgs__msg__LegsStates__fini(msg);
    return false;
  }
  // rr_leg
  if (!hyperdog_uros_msgs__msg__LegStates__init(&msg->rr_leg)) {
    hyperdog_uros_msgs__msg__LegsStates__fini(msg);
    return false;
  }
  // rl_leg
  if (!hyperdog_uros_msgs__msg__LegStates__init(&msg->rl_leg)) {
    hyperdog_uros_msgs__msg__LegsStates__fini(msg);
    return false;
  }
  return true;
...
hyperdog_uros_msgs__msg__LegsStates__fini(hyperdog_uros_msgs__msg__LegsStates * msg)
{
  ...
  // fr_leg
  hyperdog_uros_msgs__msg__LegStates__fini(&msg->fr_leg);
  // fl_leg
  hyperdog_uros_msgs__msg__LegStates__fini(&msg->fl_leg);
  // rr_leg
  hyperdog_uros_msgs__msg__LegStates__fini(&msg->rr_leg);
  // rl_leg
  hyperdog_uros_msgs__msg__LegStates__fini(&msg->rl_leg);
}
...
hyperdog_uros_msgs__msg__LegsStates__are_equal(const hyperdog_uros_msgs__msg__LegsStates * lhs, const hyperdog_uros_msgs__msg__LegsStates * rhs)
{
  ...
  if (!hyperdog_uros_msgs__msg__LegStates__are_equal(
      &(lhs->fr_leg), &(rhs->fr_leg)))
  {
    return false;
  }
  // fl_leg
  if (!hyperdog_uros_msgs__msg__LegStates__are_equal(
      &(lhs->fl_leg), &(rhs->fl_leg)))
  {
    return false;
  }
  // rr_leg
  if (!hyperdog_uros_msgs__msg__LegStates__are_equal(
      &(lhs->rr_leg), &(rhs->rr_leg)))
  {
    return false;
  }
  // rl_leg
  if (!hyperdog_uros_msgs__msg__LegStates__are_equal(
      &(lhs->rl_leg), &(rhs->rl_leg)))
  {
    return false;
  }
  return true;
  ...
  hyperdog_uros_msgs__msg__LegsStates * output)
{
  ...
  if (!hyperdog_uros_msgs__msg__LegStates__copy(
      &(input->fr_leg), &(output->fr_leg)))
  {
    return false;
  }
  // fl_leg
  if (!hyperdog_uros_msgs__msg__LegStates__copy(
      &(input->fl_leg), &(output->fl_leg)))
  {
    return false;
  }
  // rr_leg
  if (!hyperdog_uros_msgs__msg__LegStates__copy(
      &(input->rr_leg), &(output->rr_leg)))
  {
    return false;
  }
  // rl_leg
  if (!hyperdog_uros_msgs__msg__LegStates__copy(
      &(input->rl_leg), &(output->rl_leg)))
  {
    return false;
  }
  return true;
