...
hyperdog_uros_msgs__msg__LegStates__init(hyperdog_uros_msgs__msg__LegStates * msg)
{
  ...
  // leg_id
  if (!rosidl_runtime_c__String__Sequence__init(&msg->leg_id, 0)) {
...
hyperdog_uros_msgs__msg__LegStates__fini(hyperdog_uros_msgs__msg__LegStates * msg)
{
  ...
  // leg_id
  rosidl_runtime_c__String__Sequence__fini(&msg->leg_id);
  // is_contacted
  // position
  // velocity
  // applied_force
...
hyperdog_uros_msgs__msg__LegStates__are_equal(const hyperdog_uros_msgs__msg__LegStates * lhs, const hyperdog_uros_msgs__msg__LegStates * rhs)
{
  ...
  // applied_force
  for (size_t i = 0; i < 3; ++i) {
    if (lhs->applied_force[i] != rhs->applied_force[i]) {
      return false;
    }
  }
  // reaction_force
  for (size_t i = 0; i < 3; ++i) {
    if (lhs->reaction_force[i] != rhs->reaction_force[i]) {
      return false;
    }
  }
  // error_code
  ...
  hyperdog_uros_msgs__msg__LegStates * output)
{
  ...
  // applied_force
  for (size_t i = 0; i < 3; ++i) {
    output->applied_force[i] = input->applied_force[i];
  }
  // reaction_force
  for (size_t i = 0; i < 3; ++i) {
    output->reaction_force[i] = input->reaction_force[i];
  }
  // error_code
