...
#ifndef HYPERDOG_UROS_MSGS__SRV__DETAIL__SET_MOTOR_PARAMS__FUNCTIONS_H_
#define HYPERDOG_UROS_MSGS__SRV__DETAIL__SET_MOTOR_PARAMS__FUNCTIONS_H_
...
#include "hyperdog_uros_msgs/srv/detail/set_motor_params__struct.h"

/// Initialize srv/SetMotorParams message.
/**
...
/// Finalize srv/SetMotorParams message.
/**
...
/// Create srv/SetMotorParams message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Request__init().
...
/// Destroy srv/SetMotorParams message.
/**
 * It calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Request__fini()
...
/// Check for srv/SetMotorParams message equality.
/**
...
/// Copy a srv/SetMotorParams message.
/**
...
/// Initialize array of srv/SetMotorParams messages.
/**
...
/// Finalize array of srv/SetMotorParams messages.
/**
 * It calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Request__fini()
...
/// Create array of srv/SetMotorParams messages.
/**
 * It allocates the memory for the array and calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetMotorParams messages.
/**
 * It calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetMotorParams message array equality.
/**
...
/// Copy an array of srv/SetMotorParams messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hyperdog_uros_msgs
...
/**
 * It calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hyperdog_uros_msgs
...
/**
 * It allocates the memory for the array and calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hyperdog_uros_msgs
...
/**
 * It calls
 * hyperdog_uros_msgs__srv__SetMotorParams_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HYPERDOG_UROS_MSGS__SRV__DETAIL__SET_MOTOR_PARAMS__FUNCTIONS_H_
